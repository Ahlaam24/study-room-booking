...
A modern, user-friendly web application for university students to book study rooms. This is a front-end only application that uses localStorage to persist booking data.
...
The app includes 8 different study rooms with various features:

- **Capacity**: Rooms accommodate 2, 4, 6, or 8+ people
- **Amenities**: Whiteboards, projectors, TV screens, video conferencing, power outlets, and WiFi
- **Multiple Floors**: Rooms are located across different floors of the building
